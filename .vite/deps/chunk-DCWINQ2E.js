...
var Popover = React6.forwardRef(({
  ...
  return (0, import_jsx_runtime5.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime4.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime4.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react12.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime6.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React8.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime9.jsxs)(import_jsx_runtime8.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react14.cloneElement)(children, triggerProps), (0, import_jsx_runtime7.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
//# sourceMappingURL=chunk-DCWINQ2E.js.map
