...
function Modal({ show, onHide }: { show: boolean; onHide: () => void }) {
    return <BootstrapModal show={show} onHide={onHide}>
        <BootstrapModal.Header closeButton>
            <BootstrapModal.Title>Status - Create</BootstrapModal.Title>
        </BootstrapModal.Header>
        <BootstrapModal.Body>
            <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                    <Form.Label>Status Name</Form.Label>
                    <Form.Control required type="text" placeholder="Enter status name." />
                </Form.Group>
            </Row>
            <Row>
...
function ModalDelete({ show, onHide }: { show: boolean; onHide: () => void }) {
    ...
    >
        ...
        <BootstrapModal.Body>Disable Selected Status</BootstrapModal.Body>
        <BootstrapModal.Footer>
