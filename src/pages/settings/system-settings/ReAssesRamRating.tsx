...
function Modal({ show, onHide }: { show: boolean; onHide: () => void }) {
    return <BootstrapModal show={show} onHide={onHide}>
        <BootstrapModal.Header closeButton>
            <BootstrapModal.Title>Re Asses Ram Rating - Create</BootstrapModal.Title>
        </BootstrapModal.Header>
        <BootstrapModal.Body>
            <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                    <Form.Label>Re Asses Ram Rating Name</Form.Label>
                    <Form.Control required type="text" placeholder="Enter re asses ram rating name." />
                </Form.Group>
            </Row>
            <Row>
    ...
    >
        <BootstrapModal.Header closeButton>
            <BootstrapModal.Title id="example-modal-sizes-title-sm">
                Disable Re Asses Ram Rating
            </BootstrapModal.Title>
        </BootstrapModal.Header>
        <BootstrapModal.Body>Disable Re Asses Ram Rating?</BootstrapModal.Body>
        <BootstrapModal.Footer>
