...
const columns: TableColHead = [
    {
        colHead: 'Initial Ram Rating Name',
    },
    {
        colHead: 'Description',
    },
...
function Modal({ show, onHide }: { show: boolean; onHide: () => void }) {
    return <BootstrapModal show={show} onHide={onHide}>
        <BootstrapModal.Header closeButton>
            <BootstrapModal.Title>Initial Ram Rating - Create</BootstrapModal.Title>
        </BootstrapModal.Header>
        <BootstrapModal.Body>
            <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                    <Form.Label>Initial Ram Rating Name</Form.Label>
                    <Form.Control required type="text" placeholder="Enter initial ram rating name." />
                </Form.Group>
            </Row>
            <Row>
    ...
    >
        <BootstrapModal.Header closeButton>
            <BootstrapModal.Title id="example-modal-sizes-title-sm">
                Disable Initial Ram Rating
            </BootstrapModal.Title>
        </BootstrapModal.Header>
        <BootstrapModal.Body>Disable Initial Ram Rating?</BootstrapModal.Body>
        <BootstrapModal.Footer>
